...
func New(deps Dependencies) http.Handler {
	...
	apiMux.HandleFunc("/api/mounts", a.withAuth(a.mounts))
	apiMux.HandleFunc("/api/tree", a.withAuth(a.tree))
	apiMux.HandleFunc("/api/files", a.withAuth(a.files))
	apiMux.HandleFunc("/api/search", a.withAuth(a.search))
	apiMux.HandleFunc("/api/files/folder", a.withAuth(a.mkdir))
	apiMux.HandleFunc("/api/files/copy", a.withAuth(a.copy))
	apiMux.HandleFunc("/api/files/move", a.withAuth(a.move))
	apiMux.HandleFunc("/api/files/rename", a.withAuth(a.rename))
	apiMux.HandleFunc("/api/files/delete", a.withAuth(a.remove))
	apiMux.HandleFunc("/api/preview", a.withAuth(a.preview))
	apiMux.HandleFunc("/api/files/content", a.withAuth(a.fileContent))
	apiMux.HandleFunc("/api/files/raw", a.withAuth(a.raw))
	apiMux.HandleFunc("/api/shares", a.withAuth(a.shares))
	apiMux.HandleFunc("/api/shares/", a.withAuth(a.shareRoute))
	apiMux.HandleFunc("/api/uploads/task", a.withAuth(a.createUploadTask))
	apiMux.HandleFunc("/api/uploads", a.withAuth(a.uploads))
	apiMux.HandleFunc("/api/tasks", a.withAuth(a.tasks))
	apiMux.HandleFunc("/api/downloads/batch", a.withAuth(a.batchDownload))
	apiMux.HandleFunc("/api/tasks/", a.withAuth(a.taskRoute))
	apiMux.HandleFunc("/api/trash", a.withAuth(a.trash))
	apiMux.HandleFunc("/api/trash/restore", a.withAuth(a.restoreTrash))
	apiMux.HandleFunc("/api/trash/delete", a.withAuth(a.deleteTrash))
	apiMux.HandleFunc("/api/public/shares/", a.publicShareRoute)

	return newProgramHandler(deps.Config, apiMux)
}
